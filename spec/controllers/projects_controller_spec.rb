...
RSpec.describe ProjectsController, type: :controller do
  before do
    ...
    request.env['HTTP_REFERER'] = 'https://oppostarter.com'
    CatarseSettings[:base_url] = 'https://oppostarter.com'
  ...
  describe 'GET push_to_online' do
    ...
    before do
      ...
      get :push_to_online, id: project.id, locale: :en
      project.reload
    end
  ...
  describe 'GET index' do
    ...
    context 'with referral link' do
      ...
      before do
        get :index, locale: :en, ref: 'referral'
      end
      ...
      context 'when project is online' do
        ...
        context 'when I cancel the project' do
          before do
            ...
            put :update, id: project.id, cancel_project: 'true', project: { posts_attributes: {"0" => { title: "test cancellation", comment_html: "<p>only a test on cancellation</p>" }}}, locale: :en
            project.reload
          end
        ...
        context 'when I try to update the project name and the about_html field' do
          before { put :update, id: project.id, project: { name: 'new_title', about_html: 'new_description' }, locale: :en }
        ...
        context 'when I try to update only the about_html field' do
          before { put :update, id: project.id, project: { about_html: 'new_description' }, locale: :en }
