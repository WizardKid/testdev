...
RSpec.shared_examples 'redirect to edit_user_path' do
  ...
  context 'when user is logged' do
    ...
    before do
      ...
      get action, id: current_user.id, locale: :en
    end
  ...
  context 'when user is not logged' do
    ...
    before do
      ...
      get :settings, id: current_user.id, locale: :en
    end
...
RSpec.describe UsersController, type: :controller do
  ...
  describe 'POST new_password' do
    context 'without password parameter' do
      before do
        post :new_password, id: user.id, locale: 'en'
      end
    ...
    context 'with an invalid password parameter' do
      before do
        post :new_password, id: user.id, locale: 'en', password: '12'
      end
    ...
    context 'with a valid password parameter' do
      before do
        post :new_password, id: user.id, locale: 'en', password: 'newpassword123'
      end
  ...
  describe 'PUT update' do
    ...
    context 'with out password parameters' do
      ...
      before do
        ...
        put :update, id: user.id, locale: 'en', user: { twitter: 'test', unsubscribes: { project.id.to_s => '1' } }
      end
    ...
    context 'with mail marteking attributes' do
      ...
      before do
        put :update, id: user.id, locale: 'en', user: {
    ...
    context 'removing category followers' do
      ...
      before do
        create(:category_follower, user: user)
        put :update, id: user.id, category_followers_form: true, locale: 'en', user: { twitter: 'test', unsubscribes: { project.id.to_s => '1' }, category_followers_attributes: [] }
      end
  ...
  describe 'GET show' do
    before do
      get :show, id: user.id, locale: 'en', ref: 'test'
    end
