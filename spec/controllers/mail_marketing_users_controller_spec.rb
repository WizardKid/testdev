...
RSpec.describe MailMarketingUsersController, type: :controller do
  describe '#subscribe' do
    ...
    context 'when email is on user database' do
      ...
      before do
        ...
        get :subscribe, locale: 'en', EMAIL: "foo@bar.com", list_id: mail_list.list_id
      end
    ...
    context 'using invalid email' do
      before do
        ...
        get :subscribe, locale: 'en', EMAIL: "foobar.com", list_id: mail_list.list_id
      end
  ...
  describe '#unsubscribe' do
    context 'with invalid token' do
      before do
        expect(SendgridSyncWorker).not_to receive(:perform_async)
        get :unsubscribe, locale: 'en', unsubcribe_token: SecureRandom.uuid
      end
    ...
    context 'with valid token' do
      ...
      before do
        ...
        get :unsubscribe, locale: 'en', unsubcribe_token: mail_marketing_user.unsubcribe_token
      end
