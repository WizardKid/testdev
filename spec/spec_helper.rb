...
RSpec.configure do |config|
  ...
  config.before(:each) do
    ...
    CatarseSettings[:base_domain] = 'oppostarter.com'
    CatarseSettings[:host] = 'oppostarter.com'
    ...
    CatarseSettings[:company_name] = 'OppoStarter'
    CatarseSettings[:timezone] = ActiveSupport::TimeZone.find_tzinfo(timezone).name
    CatarseSettings[:jwt_secret] = 'bUH75katNm6Yj0iPSchcgUuTwYAzZr7C'
